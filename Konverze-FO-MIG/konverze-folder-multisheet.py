...
defined_sheets = ['ECZ', 'ESK', 'EHO']
for l in ListExcel.index:
    InFileXls = '.\\XLS\\' + ListExcel.at[l, 'INEXCELNAME']
    xls = pd.ExcelFile(InFileXls)
    sheets = xls.sheet_names
    for SheetName in sheets:
      if SheetName in defined_sheets:
        OutFileCsv = '.\\CSV\\' + SheetName + '-' + ListExcel.at[l, 'OUTCSVNAME']+'.csv'
        ...
        print(repString1.format(ListExcel.at[l, 'INEXCELNAME'], SheetName, OutFileCsv))
        print('---')
